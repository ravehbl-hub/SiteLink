 ...
 * Renders the "unconfigured" state for local dev, and a role-mismatch banner
 * (notForeman) when a verified account is not a Foreman/Manager/Admin.
 */
