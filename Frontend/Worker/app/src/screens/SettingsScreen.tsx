/**
 * Settings (FR-WRK-6): dark/light theme toggle, language He/En/Tr, user profile,
        ...
        {user ? (
          <>
            <Row style={{ justifyContent: 'space-between', paddingVertical: 4 }}>
              <Body muted>{t('profile.fullName')}</Body>
              <Body>{user.fullName}</Body>
            </Row>
            <Row style={{ justifyContent: 'space-between', paddingVertical: 4 }}>
              <Body muted>{t('profile.email')}</Body>
              <Body>{user.email}</Body>
            </Row>
            <Row style={{ justifyContent: 'space-between', paddingVertical: 4 }}>
              <Body muted>{t('profile.role')}</Body>
