export const en = {
  ...
  future: {
    ...
    customersBody: 'Customer accounts and CRM are planned for a future release.',
    billingTitle: 'Billing',
    billingBody: 'Subscription and invoicing tools are planned for a future release.',
    usageTitle: 'Usage',
    usageBody: 'Usage metering and analytics are planned for a future release.',
  },
  settings: {
    title: 'Settings',
    theme: 'Theme',
